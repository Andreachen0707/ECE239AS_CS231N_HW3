...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # ================================================================ #    
    scores = X
    scores,cache_1 = affine_relu_forward(scores,self.params['W1'],self.params['b1'])
    ...
    dX_2,grads['W2'],grads['b2'] = affine_backward(grads_out,cache_2)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers,0,-1):
      ...
      if i ==self.num_layers:
        dx,grads[W_i],grads[b_i] = affine_backward(grads_out,self.cache[cache_i])
      else:
        dx,grads[W_i],grads[b_i] = affine_relu_backward(dx,self.cache[cache_i])
